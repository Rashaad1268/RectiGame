...
<div class="max-h-[calc(100vh-var(--navbar-height))] overflow-y-scroll">
	...
	<div class="flex justify-evenly mt-12">
		...
		<div class="topic-info-section">
			<h2 class="text-discordDark-360 font-semibold mb-1 text-lg">About this topic</h2>
			<div>{topic.description}</div>

			<div class="flex gap-2 mt-3">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					class="h-5 fill-discordDark-300"
					viewBox="0 0 448 512"
				...
				<span class="text-discordDark-300"
					>Created at: {dateTimeFormatter.format(new Date(topic.created_at))}</span
				>
			</div>
